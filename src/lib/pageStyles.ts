export const pageShellClass = 'min-h-full bg-slate-50/60 p-2 sm:p-3 lg:p-4';

export const pageContentClass = 'mx-auto flex w-full max-w-[1680px] flex-col gap-3 lg:gap-4';
...
export const gridScrollClass = 'max-h-[60vh] overflow-auto lg:max-h-[68vh]';
